...
>(({ className, children, ...props }, ref) => (
  <ScrollAreaPrimitive.Root
    ref={ref}
    className={cn("relative overflow-hidden max-h-full max-w-full", className)}
    {...props}
  >
    <ScrollAreaPrimitive.Viewport
      className="h-full w-full rounded-[inherit] overflow-auto"
      style={{
        // Improve scrolling behavior for document analysis
        scrollBehavior: "smooth",
        // Ensure content doesn't get cut off at edges
        padding: "inherit",
        // Better performance for large document tables
        WebkitOverflowScrolling: "touch",
        // Fix aspect ratio issues and prevent content from going out of screen
        maxHeight: "100%",
        maxWidth: "100%",
        aspectRatio: "auto",
